...
import { Send, RefreshCw, Lightbulb, FileText, HelpCircle, Eye, Upload, Loader2 } from 'lucide-react';
                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex gap-2">
                                <button
                                    ...
                                    className="flex items-center gap-2 px-3 py-2 rounded-lg bg-glow-vision/20 text-glow-vision text-sm hover:bg-glow-vision/30 transition-smooth"
                                >
...
const WelcomeMessage = ({ isVisionActive, hasDocuments, onSelectDocument }) => {
    return (<motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col items-center justify-center h-full text-center px-8">
        ...
        <h2 className="text-2xl font-semibold text-foreground mb-3">
            {isVisionActive ? 'Vision Tutor Mode' : 'Welcome to InsightHub AI'}
        </h2>
    ...
    return (
        ...
        >
            <div className={`max-w-[80%] space-y-2`}>
                <div
                    className={`px-4 py-3 rounded-2xl ${isUser ? 'chat-message-user rounded-br-sm' : 'chat-message-ai rounded-bl-sm'
                        }`}
                >
                    {isUser ? (
